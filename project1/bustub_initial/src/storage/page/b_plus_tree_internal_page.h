...
#define INTERNAL_BUSTUB_PAGE_SIZE ((BUSTUB_PAGE_SIZE - INTERNAL_PAGE_HEADER_SIZE) / (sizeof(MappingType)))
 ...
 * the first key is always invalid. That is to say, any search/lookup should
...
class BPlusTreeInternalPage : public BPlusTreePage {
 ...
 private:
  // Flexible array member for key value array
